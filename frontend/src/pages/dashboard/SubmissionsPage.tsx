    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-neutral-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-neutral-500 dark:text-slate-400">제출 기록 불러오는 중...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-neutral-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-500 dark:text-slate-400 mb-6">{error}</p>
          <button
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 to-neutral-100 dark:from-slate-900 dark:to-slate-800">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 -mt-4">
        {submissions.length === 0 ? (
          <div className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-neutral-200/50 dark:border-slate-700/50 p-12 text-center shadow-lg dark:shadow-none">
            <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-neutral-100 dark:bg-slate-700/50 flex items-center justify-center">
              <FileCode2 className="w-10 h-10 text-neutral-400 dark:text-slate-500" />
            </div>
            <h2 className="text-xl font-bold text-neutral-900 dark:text-white mb-2">아직 제출 기록이 없습니다</h2>
            <p className="text-neutral-500 dark:text-slate-400 mb-6">문제를 풀고 코드를 제출해보세요!</p>
            <Link
              to="/problems"
          ...
          <>
            {/* Submissions Table */}
            <div className="bg-white/80 dark:bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-neutral-200/50 dark:border-slate-700/50 overflow-hidden shadow-lg dark:shadow-none">
              {/* Table Header */}
              <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-neutral-100 dark:bg-slate-700/30 border-b border-neutral-200/50 dark:border-slate-700/50">
                <div className="col-span-4 text-xs font-medium text-neutral-500 dark:text-slate-400 uppercase tracking-wider">문제</div>
                <div className="col-span-2 text-xs font-medium text-neutral-500 dark:text-slate-400 uppercase tracking-wider">결과</div>
                <div className="col-span-2 text-xs font-medium text-neutral-500 dark:text-slate-400 uppercase tracking-wider">실행 시간</div>
                <div className="col-span-2 text-xs font-medium text-neutral-500 dark:text-slate-400 uppercase tracking-wider">메모리</div>
                <div className="col-span-2 text-xs font-medium text-neutral-500 dark:text-slate-400 uppercase tracking-wider">제출 시간</div>
              </div>

              {/* Table Body */}
              <div className="divide-y divide-neutral-200/50 dark:divide-slate-700/30">
                  ...
                  return (
                    ...
                    >
                      <div className="col-span-4">
                        <span className="text-neutral-900 dark:text-white font-medium group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">
                      ...
                      <div className="col-span-2 flex items-center gap-2 text-sm text-neutral-500 dark:text-slate-400">
                        <Cpu className="w-4 h-4 text-neutral-400 dark:text-slate-500" />
                        {submission.execution_time_ms > 0 ? `${submission.execution_time_ms}ms` : '-'}
                      </div>
                      <div className="col-span-2 flex items-center gap-2 text-sm text-neutral-500 dark:text-slate-400">
                        <HardDrive className="w-4 h-4 text-neutral-400 dark:text-slate-500" />
            ...
            {hasMore && (
              <div className="mt-8 text-center">
                <button
                  onClick={loadMore}
                  disabled={loading}
                  className="inline-flex items-center gap-2 px-8 py-3 bg-neutral-100 hover:bg-neutral-200 dark:bg-slate-700/50 dark:hover:bg-slate-700 text-neutral-700 dark:text-white rounded-xl font-medium transition-all border border-neutral-200 dark:border-slate-600/50 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {loading ? (
                    <>
