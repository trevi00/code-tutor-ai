...
Evaluates learning submissions against problem test cases by running the
submitted code in an execution sandbox. Lives in the learning package because
it operates on learning domain entities (Problem, Submission, TestCase);
it depends one-directionally on the execution package for sandboxing.
"""
