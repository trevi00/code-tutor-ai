...
def generate_linear_search(data: list[int], target: int) -> Visualization:
    ...
    for i in range(n):
        # Compare step
        states = [ElementState.VISITED if idx < i else ElementState.DEFAULT for idx in range(n)]
...
def generate_binary_search(data: list[int], target: int) -> Visualization:
    ...
    while left <= right:
        ...
        if arr[mid] == target:
            ...
            states = [ElementState.VISITED if i < left else ElementState.ACTIVE if i <= right else ElementState.DEFAULT for i in range(n)]
            ...
            states = [ElementState.ACTIVE if left <= i <= right else ElementState.VISITED if i > right else ElementState.DEFAULT for i in range(n)]
